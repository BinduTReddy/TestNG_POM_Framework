...
import Page_Objects.FinanceModule_TabLinks;
import Page_Objects.India_AppointmentLetter;
...
import Page_Objects.EmpMod_RelievingLetter;
...
public class India_Employee extends BaseClass{
	...
	EmpMod_RelievingLetter EmpRelievingLetter;
	India_AppointmentLetter AppointmentLetter;
	FinanceModule_TabLinks FinanceMod_Tabs;
	...
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void ClientModule_TabLinks(String testData) throws Exception
	{
		ClientPage=new Submit_NewClient(driver);
		Map<String,String> hmap = ExcelTestData.readDataToMap(TestId);
		ClientPage.ClientModule_TabLinks(hmap);	
	}
	...
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void AppointmentLetter_Process(String testData) throws Exception
	{
		AppointmentLetter=new India_AppointmentLetter(driver);
		Map<String,String> hmap = ExcelTestData.readDataToMap(TestId);
		AppointmentLetter.AppointmentLetter_Process(hmap);
	}
	...
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void EmpView_AllTabs(String testData) throws Exception
	{
		EmpModule=new EmpView_EmpModule(driver);
		Map<String,String> hmap = ExcelTestData.readDataToMap(TestId);
		EmpModule.EmpModule_AllTabLinks(hmap);
	}
	...
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void Termination_Process(String testData) throws Exception
	{
		EmpModule=new EmpView_EmpModule(driver);
	...
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void RelievingLetter_Process(String testData) throws Exception
	{
		EmpModule=new EmpView_EmpModule(driver);
		EmpRelievingLetter=new EmpMod_RelievingLetter(driver);
		Map<String,String> hmap = ExcelTestData.readDataToMap(TestId);
		EmpModule.External_Employee(hmap);
		EmpRelievingLetter.RelievingLetter_EmpModule(hmap);
		EmpRelievingLetter.RelievingLetter_Process(hmap);
	}
	
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void EmpReports_AllLinks(String testData) throws Exception
	{
		EmpModule=new EmpView_EmpModule(driver);
		Map<String,String> hmap = ExcelTestData.readDataToMap(TestId);
		EmpModule.EmpModule_ReportsLinks(hmap);
	}
	
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void Finance_AllTabs(String testData) throws Exception
	{
		FinanceMod_Tabs=new FinanceModule_TabLinks(driver);
		Map<String,String> hmap = ExcelTestData.readDataToMap(TestId);
		FinanceMod_Tabs.FinanceMod_TabLinks(hmap);
	}
	
	@Test(dataProvider = "TestData",dataProviderClass = TestDataProvider.class)
	public void RunPayroll_AllTabs(String testData) throws Exception
	{
		Runpayroll=new RunPayroll_Module(driver);
		Map<String,String> hmap = ExcelTestData.readDataToMap(TestId);
		Runpayroll.PayRoll_AllTabs(hmap);
	}
