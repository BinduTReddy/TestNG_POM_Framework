...
public class StateW4_EmployeePortal {	
	WebDriver driver;
	Generic_Methods lib;
	Properties  props;
	...
	@FindBy(xpath="//*[@id='tabStateW4']/div[1]/a")
	private WebElement NewStateW4Tab;

	@FindBy(xpath="//*[@id='tblEmpW4']/tbody/tr[1]")
	...
	private WebElement SWTotalAllowances;
	...
	@FindBy(xpath="//*[@id='IsSignature']")
	private WebElement StateW4IsSignature;
	...
	@FindBy(xpath="//*[@id='gridEmployeeStateW4List']//tr[1]/td[1]/a")
	private WebElement EmpPortalView;
	...
	public StateW4_EmployeePortal(WebDriver driver) throws IOException {
		this.driver=driver;
	...
	public void StateW4_EmpPortal(Map<String,String> hmap) throws Exception {
...
//			driver.findElement(By.xpath(AddAllowancesOpt)).click();
		...
		}else if (Location.equals("State Name : New York"))
		{
			...
			String ExmpOpt = "//*[@id='EmployeeStateW4_intParameter3'][@value='" + ExpValue + "']";
			driver.findElement(By.xpath(ExmpOpt)).click();
		...
		//Minnesota
				else if (Location.equals("State Name : Minnesota"))
				{
					...
					String MinnesotaMaritalstatus = "//input[@id='intParameter1'][@value='"+ MNStatus +"']";
					...
					String MNExmpstatus = "//input[@id='intParameter4'][@value='"+ MNExmp +"']";
		...
		//Wisconsin
				else if (Location.equals("State Name : Wisconsin"))
				{
					...
					String ExmpStatus = "//*[@type='checkbox']/following-sibling::label[normalize-space()='"+ Allowance +"']/preceding-sibling::input[@type='checkbox']";
		...
		//Oregon
				else if (Location.equals("State Name : Oregon"))
				{
					...
					SWExmptwithholding.click();
					Exemptcode.sendKeys(hmap.get("OR_ExmpCode"));
					StateW4IsSignature.click();
					SaveBtn.click();
					Thread.sleep(1500);	
				}
		...
		//Delaware,Colorado,New Mexico,Maryland
				else if (Location.equals("State Name : New Mexico"))
				{
					lib.select(EmpStateW4Year, hmap.get("StateW4_Year"));		
		...
		//West Virginia
				else if (Location.equals("State Name : West Virginia"))
				{
	...
	public void StateW4_Approval(Map<String,String> hmap) throws Exception  
	{	
		MgmtBtn.click();
		Thread.sleep(1000);
		Workflowmenu.click();		
		...
		Searchbyword.sendKeys(hmap.get("SearchStateW4Word"));
		SearchImg.click();
		Thread.sleep(1000);
		ImgBtnTask.click();
		Thread.sleep(1500);
