...
public class TimesheetReg_StateandFederalLaw {
	WebDriver driver;
	Generic_Methods lib;
	Properties  props;
	...
	@FindBy(xpath="//*[contains(text(),'Regular_TS_Weekly - Reports')]")
	...
	public TimesheetReg_StateandFederalLaw(WebDriver driver) throws IOException {
		this.driver=driver;
	...
	public void Reg_Timesheet(Map<String,String> hmap) throws InterruptedException, IOException{
		...
		if (Location.equals("Non-Exempt") && workLocation.equals("California"))
		{
			...
			if (Location.equals("Non-Exempt") && workLocation.equals("Virginia")||workLocation.equals("Alabama")||workLocation.equals("New Jersey")||workLocation.equals("Arizona")||
					...
					workLocation.equals("West Virginia")||workLocation.equals("Wisconsin")||workLocation.equals("Wyoming")||workLocation.equals("Alaska")||workLocation.equals("Nevada")||workLocation.equals("Puerto Rico"))
			{
				Day1.sendKeys(hmap.get("Day1"));
				driver.manage().timeouts().implicitlyWait(60,TimeUnit.SECONDS) ;
				Day2.sendKeys(hmap.get("Day2"));
