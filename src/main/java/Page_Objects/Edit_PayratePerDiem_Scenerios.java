...
public class Edit_PayratePerDiem_Scenerios {
	WebDriver driver;
	Generic_Methods lib;
	Properties  props;
	...
	@FindBy(xpath="//*[@id='Project']//th[4]/div/span")
	private WebElement Filterclick;
	
	@FindBy(xpath="//*[@id='Project']/div[2]/div/input[1]")
	private WebElement Textbox;
	
	@FindBy(xpath="//*[@id='Project']/div[2]/div/button[2]")
	...
	@FindBy(xpath="//table[@id='tblChangedPayRate']//tr[last()]/td[10]/select")
	private WebElement PerDiemType1;

	@FindBy(xpath="//table[@id='tblChangedPayRate']//tr[last()]/td[11]/input")
	private WebElement PerDiem1;

	public Edit_PayratePerDiem_Scenerios(WebDriver driver) throws IOException {
		this.driver=driver;
	...
	public void Edit_payRate(Map<String,String> hmap) throws InterruptedException, IOException{
		...
		Thread.sleep(2000);
		Textbox.click();
		Textbox.sendKeys(hmap.get("startDate"));
		Thread.sleep(1000);
		Filter.click();
		Thread.sleep(1000);
...
//		NewPayEffectiveDate.click();
	...
	public void NonClinical_PerDiem(Map<String,String> hmap) throws InterruptedException, IOException{	
		...
		BillTravelTime.sendKeys(hmap.get(""));
		...
		PayTravelTime.click();
		PayTravelTime.sendKeys(hmap.get(""));
		Thread.sleep(1000);
		payOTRate1.click();
		payOTRate1.clear();
