...
public class Regular_TS_BiWeekly {
	WebDriver driver;
	Generic_Methods lib;
	Properties  props;
	...
	public Regular_TS_BiWeekly(WebDriver driver) throws IOException {
		this.driver=driver;
...
//		Unapproved.click();
	...
	public void NonClinical_BIWeeklyRegTimesheet(Map<String,String> hmap) throws InterruptedException, IOException, ParseException{
		...
		if (dayOfWeek.equalsIgnoreCase("Monday"))
		{
			...
			try {
				lib.waitForElementLoad(TravelHrs);
		...
		else if(dayOfWeek.equalsIgnoreCase("Thursday"))
		{
			...
			try {
				lib.waitForElementLoad(TravelHrs1);
